...
(define (fish-after steps initial) (apply + (map cadr (simulate steps (freqs initial)))))
(define (a input) (fish-after 80 (parse input)))
(define (b input) (fish-after 256 (parse input)))